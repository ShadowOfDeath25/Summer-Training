...
class Car_Rental_View(object):
    ...
    car_fr,car_img=ut.create_image(root,590,320,'01.jpg')
    engine_fr,engine_img=ut.create_image(root,64,64,'engine.png')
    horsepower_fr,horsepower_img=ut.create_image(root,64,64,'horsepower.png')
    speed_fr,speed_img=ut.create_image(root,64,64,'speed.png')
    calendar_fr,calendar_img=ut.create_image(root,64,64,'calendar.png')
    dollar_fr,dollar_img=ut.create_image(root,64,64,'dollar.png.')
    call_fr,call_img=ut.create_image(root,64,64,'call.png')
    ...
    def __init__(self):
        ...
        self.rent_btn.config(command=self.f())
